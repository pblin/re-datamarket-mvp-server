...
import "/openzeppelin-solidity/contract/math/SafeMath.sol";
...
*
*/
contract ReblocDataset is ERC721Enumerable, ERC721MetadataMintable, ERC721Burnable{
  ...
  function KnownOriginDigitalAsset(address _curatorAccount) public ERC721Token("KnownOriginDigitalAsset", "RDA") {
